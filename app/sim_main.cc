...
SC_MODULE(Source) {
  ...
  sc_in< sc_biguint<1> > relay_sim_relay_func_fun_in_in;
  sc_biguint<1> relay_sim_relay_func_fun_in;
  sc_in< sc_biguint<8> > relay_sim_relay_func_id_in;
  sc_biguint<8> relay_sim_relay_func_id;
  sc_in< sc_biguint<8> > relay_sim_relay_data_in_in;
  sc_biguint<8> relay_sim_relay_data_in;
  sc_in< sc_biguint<8> > relay_sim_data_in_batch_in;
  sc_biguint<8> relay_sim_data_in_batch;
  sc_in< sc_biguint<8> > relay_sim_data_in_channel_in;
  sc_biguint<8> relay_sim_data_in_channel;
  sc_in< sc_biguint<32> > relay_sim_data_in_y_in;
  sc_biguint<32> relay_sim_data_in_y;
  sc_in< sc_biguint<32> > relay_sim_data_in_x_in;
  sc_biguint<32> relay_sim_data_in_x;
  sc_in< sc_biguint<8> > relay_sim_pool_size_y_in;
  sc_biguint<8> relay_sim_pool_size_y;
  sc_in< sc_biguint<8> > relay_sim_pool_size_x_in;
  sc_biguint<8> relay_sim_pool_size_x;
  sc_in< sc_biguint<8> > relay_sim_strides_y_in_in;
  sc_biguint<8> relay_sim_strides_y_in;
  sc_in< sc_biguint<8> > relay_sim_strides_x_in_in;
  sc_biguint<8> relay_sim_strides_x_in;
  sc_in< sc_biguint<8> > relay_sim_padding_in_y_in;
  sc_biguint<8> relay_sim_padding_in_y;
  sc_in< sc_biguint<8> > relay_sim_padding_in_x_in;
  sc_biguint<8> relay_sim_padding_in_x;
  sc_in< sc_biguint<8> > relay_sim_layout_in_in;
  sc_biguint<8> relay_sim_layout_in;
  sc_in< sc_biguint<8> > relay_sim_ceil_mode_in_in;
